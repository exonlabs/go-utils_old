...
func (log *Logger) Debug(msg string, args ...any) {
	log.Log(NewRecord(log.Name, LEVEL_DEBUG, msg, args...))
}

func (log *Logger) Info(msg string, args ...any) {
	log.Log(NewRecord(log.Name, LEVEL_INFO, msg, args...))
}

func (log *Logger) Warn(msg string, args ...any) {
	log.Log(NewRecord(log.Name, LEVEL_WARN, msg, args...))
}

func (log *Logger) Error(msg string, args ...any) {
	log.Log(NewRecord(log.Name, LEVEL_ERROR, msg, args...))
}

func (log *Logger) Fatal(msg string, args ...any) {
	log.Log(NewRecord(log.Name, LEVEL_FATAL, msg, args...))
}
